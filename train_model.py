...
def train_model(OUTPUT_FOLDER,):
    ...
    model = Sequential()
    model.add(Conv2D(32, kernel_size=(5, 5), padding='same', activation='relu', input_shape=input_shape, kernel_regularizer=regularizers.l2(0.0001)))
    print('model: added conv layer filters=32, kernel=(5,5)')
    model.add(Conv2D(32, kernel_size=(5, 5), padding='same', activation='relu', kernel_regularizer=regularizers.l2(0.0001)))
    print('model: added conv layer filters=32, kernel=(5,5)')
